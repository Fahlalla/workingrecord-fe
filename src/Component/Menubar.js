...
const Menubar = () => {
  return (
    <div className="flex">
      <div className="fixed h-screen px-20 text-center text-white bg-gray-800">
        <img className="w-24 mt-6" src={image} alt="odds" />
        <div className="mt-16">
          <button className="flex my-8 font-sans hover:text-blue-300">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2">
          ...
          <button className="flex my-8 font-sans hover:text-blue-300">
            <svg viewBox="0 0 21 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2">
