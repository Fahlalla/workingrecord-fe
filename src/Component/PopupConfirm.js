export default function PopupConfirm(props) {
  return (
    <>
      <div data-cy="confirmTransferPopup" className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
